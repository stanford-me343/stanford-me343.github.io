...
;function te(){var a=ue(),b=[];cb(a,function(a,d){var c=encodeURIComponent(String(d)),f;x(a)?f=a:f=[a];F(f,function(a){""==a?b.push(c):b.push(c+"="+encodeURIComponent(String(a)))})});
return b.join("&")}
function ve(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?x(b[f])?Oa(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(m){var h=Error("Error decoding URL component");h.params="key: "+e[0]+", value: "+e[1];"q"==e[0]?se(h):R(h)}}return b}
function we(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=ve(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);return sc(a,e)+d}
;function ue(a){var b=xe;a=void 0===a?w("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(ye(b),ze(b));b.ca_type="image";a&&(b.bid=a);return b}
function ye(a){var b={};b.dt=Ic;b.flash="0";a:{try{var c=a.b.top.location.href}catch(f){a=2;break a}a=c?c===a.f.location.href?0:1:2}b=(b.frm=a,b);b.u_tz=-(new Date).getTimezoneOffset();var d=void 0===d?D:d;try{var e=d.history.length}catch(f){e=0}b.u_his=e;b.u_java=!!D.navigator&&"unknown"!==typeof D.navigator.javaEnabled&&!!D.navigator.javaEnabled&&D.navigator.javaEnabled();D.screen&&(b.u_h=D.screen.height,b.u_w=D.screen.width,b.u_ah=D.screen.availHeight,b.u_aw=D.screen.availWidth,b.u_cd=D.screen.colorDepth);
...
var xe=new function(){var a=window.document;this.b=window;this.f=a};
v("yt.ads_.signals_.getAdSignalsString",function(){return te()},void 0);B();function Ae(a,b){var c=S(a);return void 0===c&&void 0!==b?b:Number(c||0)}
function S(a){return Q("EXPERIMENT_FLAGS",{})[a]}
;var Be=r(XMLHttpRequest)?function(){return new XMLHttpRequest}:r(ActiveXObject)?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;
...
(b["X-YouTube-Ad-Signals"]=te());return b}
function Je(a){var b=window.location.search,c=I(J(3,a)),d=I(J(5,a));d=(c=c&&c.endsWith("youtube.com"))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=ve(b),f={};F(Fe,function(a){e[a]&&(f[a]=e[a])});
return we(a,f||{},!1)}
...
return g}
function Le(a,b){b.wa&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.Va;d&&(d[c]&&delete d[c],a=we(a,d||{},!0));return a}
function Me(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.C,g=me("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.nb||I(J(3,a))&&!b.withCredentials&&I(J(3,a))!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.C&&b.C[g]||(f||(f={}),f[c]=d);f&&t(e)&&(e=ve(e),mb(e,f),e=b.ia&&"JSON"==b.ia?JSON.stringify(e):rc(e));f=e||f&&!gb(f);!Ge&&f&&"POST"!=b.method&&(Ge=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
function ug(){S("web_gel_timeout_cap")&&!pg&&(pg=T(sg,3E4));U(og);og=T(sg,Q("LOGGING_BATCH_TIMEOUT",Ae("web_gel_debounce_ms",1E4)))}
...
;function yg(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||O());f[a]=b;f.context={lastActivityMs:String(d?-1:gg())};e?(a={},e.videoId?a.videoId=e.videoId:e.playlistId&&(a.playlistId=e.playlistId),qg[e.token]=a,e=vg("log_event",e.token)):e=vg("log_event");e.push(f);c&&(ng.log_event=new c);e.length>=(Ae("web_logging_max_batch")||20)?sg():ug()}
...
;function Ei(a){if("1"!==db(ne(),"args","privembed")){a&&oe();try{Di().then(function(a){a=ue(a);a.bsq=Fi++;Te("//www.youtube.com/ad_data_204",{wa:!1,C:a,withCredentials:!0})},function(){}),T(Ei,18E5)}catch(b){R(b)}}}
